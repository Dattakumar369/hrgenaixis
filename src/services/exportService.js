...
function mapEmployeeRow(emp) {
  ...
  return {
    ...
    Email: emp.email || '',
    'Employee ID': emp.employeeCode || emp.salary?.employeeCode || '',
    Phone: emp.phone || '',
    UAN: emp.uan || emp.salary?.uan || '',
    Bank: emp.bankName || emp.salary?.bankName || '',
    'Account No.': emp.bankAccount || emp.salary?.bankAccount || '',
